(function () {
  ...
  (self["webpackChunkMisCalleslimpiasRD"] = self["webpackChunkMisCalleslimpiasRD"] || []).push([["src_app_recibos-bonos_recibos-bonos_module_ts"], {
    ...
    25317: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _modal_popover_modal_popover_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../modal-popover/modal-popover.page */
      71462);

      var _RecibosBonosPage = /*#__PURE__*/function () {
        function RecibosBonosPage(servicio, servicio2, modalCtrl) {
        ...
        _createClass(RecibosBonosPage, [{
              ...
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 2:
                      modal = _context.sent;
                      modal.onDidDismiss().then(function (modalDataResponse) {
                        if (modalDataResponse !== null) {
                          _this.modalDataResponse = modalDataResponse.data;
          ...
          value: function showAlert(i) {
            ...
            this.servicio.MostrarRecibosPorID(nuevoformatocodigobono).subscribe(function (data) {
              _this3.Recibos = data;
              _this3.fechaCompleta = _this3.Recibos[0].fechaCompleta;
      ...
      _RecibosBonosPage = (0, tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_8__.Component)({
    ...
    82030: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "/* DOES NOT WORK - not specific enough */\n.modal-wrapper {\n  background: #222;\n}\n/* Works - pass \"my-custom-class\" in cssClass to increase specificity */\n.my-custom-class .modal-wrapper {\n  background: #222;\n}\n.my-custom-class {\n  --background: #222;\n}\nion-modal.stack-modal {\n  --box-shadow: 0 28px 48px rgba(0, 0, 0, 0.4);\n  --backdrop-opacity: var(--ion-backdrop-opacity, 0.32);\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
