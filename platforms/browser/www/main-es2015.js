...
const routes = [
    ...
    {
        path: 'mensajeria',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_mensajeria_mensajeria_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./mensajeria/mensajeria.module */ 7071)).then(m => m.MensajeriaPageModule)
    },
    {
        path: 'modal-popover',
    ...
    {
        path: 'mis-puntos2',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_mis-puntos2_mis-puntos2_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./mis-puntos2/mis-puntos2.module */ 36648)).then(m => m.MisPuntos2PageModule)
    }
];
...
let AppComponent = class AppComponent {
    ...
    constructor(platform, servicio2, router) {
