...
const routes = [
    ...
    {
        path: 'informate',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_informate_informate_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./informate/informate.module */ 42368)).then(m => m.InformatePageModule)
    },
    {
        path: 'recibos-bonos',
